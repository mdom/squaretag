...
=head1 SYNOPSIS
  ...
  squaretag [-s SEP] add    [-v] [-n] [-f] TAG FILES...
  squaretag [-s SEP] remove [-v] [-n] [-f] TAG FILES...
  squaretag          clear  [-v] [-n] [-f] FILES...
  squaretag [-s SEP] rename [-v] [-n] [-f] OLD_TAG NEW_TAG FILES...
  squaretag [-s SEP] list FILES...
  squaretag [-s SEP] search [-I REGEX] SEARCH FILES...
